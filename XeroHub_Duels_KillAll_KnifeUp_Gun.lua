...
local function obtenerAttackCFKillAll(
    ...
    -- Misma posición del Kill All original, pero volteado hacia ARRIBA.
    -- -90° invierte la orientación anterior de ataque sin cambiar el tracking.
...
function runtime.KillAllGunFollowTarget(myChar, myHum, myHrp, enemyHrp)
    ...
    -- Mantiene la misma pose "debajo + mirando arriba" que el Kill All Knife.
    pcall(function()
