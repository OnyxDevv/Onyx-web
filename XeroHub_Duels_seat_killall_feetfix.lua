...
ATTACK_Y_OFFSET = -6.15
-- TP real del Character: debajo de las piernas, no encima del HRP enemigo.
ATTACK_CHARACTER_Y_OFFSET = -4.65
-- Pequeño desplazamiento local para que manos/cuchillo no queden exactamente
-- centrados dentro del enemigo y apunten hacia sus piernas.
ATTACK_FORWARD_OFFSET = 0.45
ATTACK_PITCH_DEGREES = -18
...
local HANDLE_READY_DISTANCE = 5.4
...
local function seguirObjetivoKillAll(myChar, myHrp, enemyHrp)
    ...
    -- Con una inclinación leve el avatar sigue sentado, pero la mano apunta hacia las piernas.
    pcall(function()
