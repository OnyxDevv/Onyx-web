...
UIElements.TogRoundStartSpam = Tabs.KillAll:Toggle({
    Title = "Spam Fire",
    Desc = "Ráfaga automática al iniciar cada ronda, incluso sin la gun equipada.",
    Value = false,
    Callback = function(value)
...
UIElements.SliRoundStartSpamDuration = Tabs.KillAll:Slider({
    Title = "Duración de Spam Fire",
    ...
    function runtime.RefreshFireButtons()
        ...
        for key, control in pairs(controls) do
            ...
            if key == "RoundStartSpam" and enabled then
                status = not state.InLobby and state.RoundStartSpamActiveUntil > now
                    and "RÁFAGA ACTIVA" or "EN ESPERA"
            end
