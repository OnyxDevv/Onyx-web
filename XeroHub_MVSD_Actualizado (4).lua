...
Tabs.KillAll:Section({Title = "Rapid Fire"})

UIElements.TogRapidFire = Tabs.KillAll:Toggle({
...
UIElements.TogRapidFireButton = Tabs.KillAll:Toggle({
...
UIElements.SliRapidFireRate = Tabs.KillAll:Slider({
...
UIElements.TogHitboxExpander = Tabs.Hitbox:Toggle({
    ...
    Desc = "Expande la hitbox de colisión.",
