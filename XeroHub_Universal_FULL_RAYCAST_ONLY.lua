...
-- ==========================================
-- SILENT AIM HOOK · UNIVERSAL V3 / RAYCAST ONLY
-- ==========================================
...
do
    ...
    local oldV2 = runtimeEnv.__XERO_UNIVERSAL_AIM_STATE_V3
    if type(oldV2) == "table" then
        oldV2.Target = nil
        oldV2.TargetInstance = nil
        oldV2.TargetPosition = nil
        oldV2.TargetCFrame = nil
        oldV2.Mouse = nil
        oldV2.Runtime = {Alive = false}
        oldV2.ToolActive = false
        oldV2.ShotUntil = 0
    end
end
...
local aimHookState = runtimeEnv.__XERO_UNIVERSAL_AIM_STATE_V3
...
if type(aimHookState) ~= "table" then
    ...
    runtimeEnv.__XERO_UNIVERSAL_AIM_STATE_V3 = aimHookState
else
...
if not aimHookState.Hooked then
    ...
    oldNamecall = hookmetamethod(game, "__namecall", function(self, ...)
        local hookState = runtimeEnv.__XERO_UNIVERSAL_AIM_STATE_V3
...
UIElements.TogSilentAim = Tabs.Aim:Toggle({
    Title = "Silent Aim",
    Desc = "Universal seguro: redirige solo Raycast de disparo.",
    Value = false,
...
print("[XeroHub] UNIVERSAL V3 cargado | Raycast-only Silent | UI Xero | by Kev")
